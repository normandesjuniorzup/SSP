...
public class EarlyAlertServiceImpl extends // NOPMD
	 ...
	 * @throws ValidationException
	 */
	private void sendMessageToAdvisor(@NotNull final EarlyAlert earlyAlert, final String emailCC) throws ObjectNotFoundException, ValidationException, SendFailedException {
	...
	private <E extends Exception> void checkNotNull(Object object, E e) throws E {
		//1
		if (object == null) {
			throw e;
		}
